...
def latest_bracket(
    ...
    report, generated by bracket/bracket.py. It's a fully self-styled
    page (its own fonts/theme), so it's served as-is rather than
    poured into base.html — we just splice in a small link back to
    the dashboard."""
